...
This command **requires** the project directory as an argument via `D:\git\consent-app\app`.

**Example:** `/create-spec generations/my-app`

**Output location:** `D:\git\consent-app\app/.autoforge/prompts/app_spec.txt` and `D:\git\consent-app\app/.autoforge/prompts/initializer_prompt.md`

If `D:\git\consent-app\app` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `D:\git\consent-app\app/.autoforge/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `D:\git\consent-app\app/.autoforge/prompts/app_spec.txt`
...
**Output path:** `D:\git\consent-app\app/.autoforge/prompts/initializer_prompt.md`
...
**Output path:** `D:\git\consent-app\app/.autoforge/prompts/.spec_status.json`
...
> "Your specification files have been created in `D:\git\consent-app\app/.autoforge/prompts/`!
>
> **Files created:**
> - `D:\git\consent-app\app/.autoforge/prompts/app_spec.txt`
> - `D:\git\consent-app\app/.autoforge/prompts/initializer_prompt.md`
>
