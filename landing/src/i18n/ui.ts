...
export const ui = {
  fr: {
    ...
    'highlight.qr.desc': 'Affiche un QR code que ta relation peut scanner pour te rejoindre, ou partage un simple lien. Pas besoin de chercher dans un annuaire.',
    ...
    'step.1.desc': 'Affiche un QR code que l\'autre peut scanner, ou partage un lien d\'invitation. L\'autre personne crée son compte gratuitement.',
    ...
    'feature.qr.desc': 'Affiche un QR code unique que ta relation peut scanner pour te rejoindre, ou partage un lien d\'invitation. Un scan suffit pour être connectés.',
    ...
    'how.step.2.desc': 'Génère et affiche un QR code : ta relation le scanne pour rejoindre ta liste. Tu peux aussi partager un lien à distance. L\'autre personne crée son compte et vous êtes connectés.',
  ...
  en: {
    ...
    'highlight.qr.desc': 'Display a QR code your contact can scan to join you, or share a simple link. No need to search through a directory.',
    ...
    'step.1.desc': 'Display a QR code they can scan, or share an invitation link. The other person creates their free account.',
    ...
    'feature.qr.desc': 'Display a unique QR code your contact can scan to join your relations, or share an invitation link. One scan is all it takes to connect.',
    ...
    'how.step.2.desc': 'Generate and display a QR code: your contact scans it to join your list. Or share a link remotely. The other person creates their account and you\'re connected.',
