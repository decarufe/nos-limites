      ...
      {activeTab === "mes-limites" && (
        <div className={styles.limitsContainer}>
          ...
          <div className={styles.encouragementMessage}>
            ...
            <p>Plus vous cochez de limites, plus vous en découvrirez en commun</p>
          </div>
      ...
      {activeTab === "en-commun" && (
        <div className={styles.limitsContainer}>
          {commonLoading ? (
            ...
            <>
              {/* My limits vs common summary */}
              <div className={styles.limitsSummary}>
                <div className={styles.limitsSummaryItem}>
                  <span className={styles.limitsSummaryNumber}>{myLimitsCount}</span>
                  <span className={styles.limitsSummaryLabel}>Mes limites</span>
                </div>
                <svg
                  width="16"
                  height="16"
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className={styles.limitsSummaryArrow}
                >
                  <polyline points="9 18 15 12 9 6" />
                </svg>
                <div className={styles.limitsSummaryItem}>
                  <span className={styles.limitsSummaryNumberCommon}>{commonLimits.length}</span>
                  <span className={styles.limitsSummaryLabel}>En commun</span>
                </div>
              </div>
              {myLimitsCount > commonLimits.length && (
                <div className={styles.mismatchHint}>
                  <svg
                    width="16"
                    height="16"
                    viewBox="0 0 24 24"
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className={styles.mismatchHintIcon}
                  >
                    <circle cx="12" cy="12" r="10" />
                  ...
                  <p>
                    {myLimitsCount - commonLimits.length} de vos limites n'ont pas encore de correspondance avec {relationship.partnerName || "votre partenaire"}
                  </p>
                </div>
              )}
                ...
                <div className={styles.commonList}>
                  ...
                  {commonLimits.map((limit) => (
                    <div key={limit.id} className={styles.commonItem}>
                      <div className={styles.commonItemHeader}>
                        <svg
                          width="20"
                          height="20"
                          viewBox="0 0 24 24"
                      ...
                      {limit.note && (
                        <div className={styles.commonNote}>
                          ...
                          <div>
                            <span className={styles.commonNoteAuthor}>Moi :</span>
                            <span> {limit.note}</span>
                          </div>
                        </div>
                      )}
                      {limit.partnerNote && (
                        <div className={`${styles.commonNote} ${styles.commonNotePartner}`}>
                          <svg
                            width="14"
                            height="14"
                            viewBox="0 0 24 24"
                          ...
                          <div>
                            <span className={styles.commonNoteAuthor}>{relationship.partnerName || "Partenaire"} :</span>
                            <span> {limit.partnerNote}</span>
                          </div>
                        </div>
                      )}
                    </div>
